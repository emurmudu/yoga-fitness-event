...
const Footer = () => {
    return (
        <footer className="footer flex flex-col md:flex-row md:justify-between items-center px-10 py-4 border-t bg-base-200 text-pink-400 font-bold border-base-300">
            <aside className="items-center grid-flow-col items-center">
                ...
                <p>YoGa & Fitness Retreats <br />Providing reliable services since 1992</p>
            </aside>
